...
workflow classify_cholera {
    ...
    output {
        ...
        Float vibecheck_conflict        = vibecheck.conflict
        String vibecheck_usher_notes    = vibecheck.usher_notes
...
task vibecheck {
    ...
    command <<<
        ...
        with open( "lineage_report.csv", "rt" ) as csv_file:
            ...
            line = next( reader )
            for key in ["lineage", "conflict", "usher_note", "qc_status", "qc_notes"]:
